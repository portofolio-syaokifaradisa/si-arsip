document.addEventListener("DOMContentLoaded", function(){
    ...
    const table = $("#datatable").dataTable({
        ...
        columns: [
            ...
            { 
                ...
                orderable: false, 
                searchable: false,
                render: function(_, type, akun, meta){
                    return `
                        <div class="btn-group dropright px-0 pr-2">
                            ...
                            <div class="dropdown-menu dropright">
                                <a class="dropdown-item has-icon" href="${window.location.href}/${akun.id}/edit">
                                    <i class="fas fa-edit"></i>
                                    Edit
                                </a>
                                <a class="dropdown-item has-icon delete-button" id="pegawai-${akun.id}" href="#">
    ...
    $('#datatable tfoot th').each(function (index) {
        ...
        if(['nama', 'nip', 'email'].includes(name)){
            $(this).html(`
    ...
    $('#datatable').on('draw.dt', function (datatable) {
        ...
        for(let deleteButton of deleteButtons){
            ...
            deleteButton.addEventListener('click', function(e){
                ...
                confirmAlert(
                    "Konfirmasi Penghapusan Data Akun",
                    "Apakah Anda Yakin ingin Menghapus Data Akun?",
                    async function(){
