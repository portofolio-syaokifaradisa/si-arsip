        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="{{ asset('logo.png') }}" alt="logo" width="100" class="shadow-light">
            </div>
              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('verify') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" tabindex="1" autofocus>
                        @error('email')
